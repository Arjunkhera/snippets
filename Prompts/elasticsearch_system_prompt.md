...
- **authorization.isAuthZ**: Boolean flag indicating if authZ based authorization is enabled on this entity
- **authorization.isPci**: Boolean flag indicating if the entity is persisted in the PCI region
- **authorization.isTargetState**: Boolean flag to determine whether the document is target set authorization model or not.
- **authorization.ownerMetadata**: Parent objects containing the ownerMetadata fields that are used for target set authorization.
- **authorization.ownerMetadata.accountId**: Account ID of the owner that is stored in ownerMetadata for target set authorization.
- **authorization.ownerMetadata.contextId**: Context ID for the ownership that is stored in ownerMetadata for target set authorization.
...
- **commonAttributes**: Common alphabet metadata for the document provided are run-time by the client.
...
- **commonAttributes.applicationAttributes.relationshipId**: ID representing the relationship
...
- **commonAttributes.name**: Entity name of the entity
...
- **organizationAttributes**: Organization attributes provide the properties related to the path structure of folders and documents
- **organizationAttributes.folderPath**: This contains the list of all the folder names that are present in the path of the current entity.
- **organizationAttributes.folderPathIds**: This contains the actual UU IDs or the entity IDs of all the folders present in the path of the current entity.
- **organizationAttributes.parentFolderId**: This contains the UUID or the Entity ID of the parent folder
...
{
  "_index": "entities-v4",
  "_id": "4621027474543685332_30398388-e3ee-467a-b342-3bc8c33f3af8",
  "_score": 27.77823,
  ...
  "_source": {
    ...
    "organizationAttributes": {
      "folderPath": "root/Arjun-Parent-Folder-Target-Test-2/SubFolder-1-Failure-Test",
      "parentFolderId": "4d3a2df1-1678-498c-99ee-b55960542d30",
      "folderPathIds": [
        "root",
        "280d02d2-ec61-4996-a84b-648ceab69476",
    ...
    "systemAttributes": {
      ...
      "version": "1763208691711|document|30398388-e3ee-467a-b342-3bc8c33f3af8",
      "userCreateDate": 1763208684696,
      "createDate": 1763208691711,
      "modifyDate": 1763208691628,
      "ttlExpDate": 1763295084694,
      "owner": {
      ...
      "masterVersion": 1763208691629,
      "isTargetState": false,
      "isAutoEnforcedTTL": false,
      "selfLocator": "/documents/30398388-e3ee-467a-b342-3bc8c33f3af8",
      "channel": "upload",
      "sourceLocators": [
        {
          "contentType": "image/png",
          "index": "1",
          "locator": "/documents/30398388-e3ee-467a-b342-3bc8c33f3af8/sources/1",
          ...
          "thumbnailLocators": [
            {
              ...
              "locator": "/documents/30398388-e3ee-467a-b342-3bc8c33f3af8/sources/1/thumbnails?imageSize=medium",
              "contentType": "image/jpeg"
            },
            {
              "thumbnailType": "extraLarge",
              "locator": "/documents/30398388-e3ee-467a-b342-3bc8c33f3af8/sources/1/thumbnails?imageSize=extraLarge",
              "contentType": "image/jpeg"
            },
            {
              "thumbnailType": "large",
              "locator": "/documents/30398388-e3ee-467a-b342-3bc8c33f3af8/sources/1/thumbnails?imageSize=large",
              "contentType": "image/jpeg"
            }
          ]
        }
      ...
      "alternateDataLocators": [
        {
          ...
          "locator": "/documents/30398388-e3ee-467a-b342-3bc8c33f3af8/alternateData/desResponseData"
        },
        {
          "contentType": "desRequestData",
          "alternateDataType": "desRequestData",
          "locator": "/documents/30398388-e3ee-467a-b342-3bc8c33f3af8/alternateData/desRequestData"
        },
        {
          "contentType": "rawSemanticData",
          "alternateDataType": "rawSemanticData",
          "locator": "/documents/30398388-e3ee-467a-b342-3bc8c33f3af8/alternateData/rawSemanticData"
        }
      ],
      "size": 326603
    },
    "commonAttributes": {
      ...
      "additionalIds": {
        "correlationId": "c911883f-851c-4ff4-aaff-3e6fc21c2706"
      },
      "domainAttributes": [
        {
          "domain": "BUSINESS",
